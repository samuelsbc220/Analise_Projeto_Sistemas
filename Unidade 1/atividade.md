...
| Campo | Preenchimento |
|---|---|
| Nome do sistema | Sistema de Reclamações da UDF |
| Objetivo | Gerenciar reclamações e criar um canal para resolução de problemas e dúvidas. |
| Público-alvo | Alunos. |
...
|---|---|
| **Identificação** | RF01 |
| **Descrição** | O sistema deve permitir que os usuários cadastrados consigam enviar as suas reclamações. |
| **Prioridade** | Alta |
